...
public record CompileApplication(Sources sources, Compiler compiler, Targets targets) implements Application {
    private static Option<Error> compileAndWrite(final Map<String, String> inputs, final Compiler compiler, final Targets targets) {
    ...
    private static Option<Error> writeTarget(final String compiled, final Targets targets) {

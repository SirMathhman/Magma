...
public class Lang {
    public static Rule<Node, Result<Node, FormattedError>, StringResult> createJavaRootRule() {
    ...
    static Rule<Node, Result<Node, FormattedError>, StringResult> createStructureRule(String type) {
    ...
    public static Rule<Node, Result<Node, FormattedError>, StringResult> createPlantRootRule() {
        return new DivideRule("children", new OrRule<>(List.of(createDependencyRule()), ResultFactoryImpl.create()));
    }

    static Rule<Node, Result<Node, FormattedError>, StringResult> createNamespacedRule(String type) {
    ...
    static Rule<Node, Result<Node, FormattedError>, StringResult> createDependencyRule() {

...
record MutableAccumulator<Value, Error>(Optional<Value> maybeValue,
    ...
    @Override
    public <Result extends AttachableToStateResult<Accumulator<Value, Error, Iterable<Error>>>> Result match(Function<Value, Result> whenOk, Function<Iterable<Error>, Result> whenErr) {

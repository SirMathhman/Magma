...
public class CommonLang {
    private static final RuleBuilder<Rule<NodeWithEverything, NodeResult<NodeWithEverything, FormattedError, StringResult<FormattedError>>, StringResult<FormattedError>>> BUILDER = new FactoryRuleBuilder<>(DefaultCompileResultFactory.create(), new MapNodeFactory());

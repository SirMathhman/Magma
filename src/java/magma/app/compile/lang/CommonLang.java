...
public class CommonLang {
    private static final RuleBuilder<FormattedError> BUILDER = new FactoryRuleBuilder<FormattedError>(DefaultCompileResultFactory.create());

    public static Rule<NodeWithEverything, FormattedError> createPlantUMLRootRule() {
        return BUILDER.NodeList(List.of(createDependencyRule(), BUILDER.Empty()));
    }

    private static Rule<NodeWithEverything, FormattedError> createDependencyRule() {
    ...
    public static Rule<NodeWithEverything, FormattedError> createJavaRootRule() {
        return BUILDER.NodeList(List.of(createImportRule(), BUILDER.String("value")));
    }

    private static Rule<NodeWithEverything, FormattedError> createImportRule() {
        final var parent = BUILDER.String("parent");
        final var child = BUILDER.String("child");

...
public class PlantLang {
    public static Rule<NodeWithEverything, NodeResult<NodeWithEverything>, Result<String, CompileError>> createImplementsRule() {
    ...
    public static Rule<NodeWithEverything, NodeResult<NodeWithEverything>, Result<String, CompileError>> createPlantUMLClassesRule() {
        return new OrRule<>(Lists.of(createPlantUMLClassRule("class"), createPlantUMLClassRule("interface")));
    }

    public static Rule<NodeWithEverything, NodeResult<NodeWithEverything>, Result<String, CompileError>> createPlantUMLClassRule(String type) {
    ...
    public static Rule<NodeWithEverything, NodeResult<NodeWithEverything>, Result<String, CompileError>> createPlantRootSegmentRule() {
        return ModifyRule.Suffix(new OrRule<>(Lists.of(createDependencyRule(),
                createPlantUMLClassesRule(),
                createImplementsRule())), "\n");
    }

    public static Rule<NodeWithEverything, NodeResult<NodeWithEverything>, Result<String, CompileError>> createPlantRootRule() {
        return ExtractRule.NodeList("children", createPlantRootSegmentRule(), new MapNodeFactory());
    }

    public static Rule<NodeWithEverything, NodeResult<NodeWithEverything>, Result<String, CompileError>> createDependencyRule() {

...
public final class MapNode implements NodeWithEverything {
    ...
    private MapLike<String, Foldable<NodeWithEverything>> nodeLists;

    public MapNode() {
        this(Optional.empty(), Maps.empty(), Maps.empty(), Maps.empty());
    }

    public MapNode(Optional<String> maybeType, MapLike<String, String> strings, MapLike<String, NodeWithEverything> nodes, MapLike<String, Foldable<NodeWithEverything>> nodeLists) {
    ...
    @Override
    public NodeWithEverything withNodeList(String key, Foldable<NodeWithEverything> values) {
        this.nodeLists = this.nodeLists.put(key, values);
        return this;
    }

    @Override
    public Optional<Foldable<NodeWithEverything>> findNodeList(String key) {

...
public class JavaLang {
    ...
    public static Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> createJavaRootSegmentRule() {
    ...
    private static Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> createStructureRule(final String type) {
        final var anImplements = JavaLang.createStructureHeaderRule(type);

        final Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> content =
    ...
    private static Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> createStructureHeaderRule(
            final String type) {
        final Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> name = new StripRule<>(
        ...
        final var withTypeParameters = new SuffixRule<>(CommonLang.First(name, "<", new StringRule<>("type-parameters",
                                                                                                     ...
                                                                                                     new MapNodeFactory())),
                                                        ">", ResultFactoryImpl.get());
        final Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>>
                maybeWithTypeParams =
        ...
        final Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> modifiers =
    ...
    private static Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> createNamespaceRule(final String type) {
        final Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> child =
    ...
    private static Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> createTypeRule() {
    ...
    private static Rule<EverythingNode, NodeResult<EverythingNode, FormatError>, StringResult<FormatError>> createGenericRule() {

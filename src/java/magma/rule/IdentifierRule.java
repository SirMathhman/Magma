...
public final class IdentifierRule<Node, Error> implements Rule<Node, NodeResult<Node, Error>, StringResult<Error>> {
    ...
    public IdentifierRule(final Rule<Node, NodeResult<Node, Error>, StringResult<Error>> rule,

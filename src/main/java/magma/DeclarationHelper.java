...
public class DeclarationHelper {
	 ...
	 */
	private static Declaration handleStructTypedDeclaration(String valuePart,
	 ...
	 */
	private static Declaration handleBooleanTypedDeclaration(String valuePart,
																													 Map<String, VarInfo> env,
																													 String stmt,
																													 String cType) throws CompileException {
	 ...
	 */
	private static Declaration handleNumericTypedDeclaration(String valuePart,
																													 Map<String, VarInfo> env,
																													 String stmt,
																													 String cType) throws CompileException {

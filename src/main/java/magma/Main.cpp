...
char* toString_StringBuilder(void* _ref){
	StringBuilder* _this = (StringBuilder*) _ref;
	return collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Char]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Char]]', not an object.]*/(iter_List(_this->list, ), F? { alloc(String), F?Table { valueOf }}), new_Joiner());
}
template <typename T, typename T>
Iter<T> of_Iter(void* _ref, T value){
...
R fold_Iter(void* _ref, R initial, F2R<R, T, R> folder){
	...
	while (true) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'toTuple' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'next' in 'JGenericType[base=Head, typeArguments=[Identifier[value=T]]]', not an object.]]', not an object.]]', not an object.]*/ tuple = toTuple_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'next' in 'JGenericType[base=Head, typeArguments=[Identifier[value=T]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'JGenericType[base=Head, typeArguments=[Identifier[value=T]]]', not an object.]*/(next_Head(_this->head, ), lambda0), lambda1);
		if (tuple.left) 
			current = tuple.right;
		return current;
	}
...
char* generate_CTemplateType(void* _ref){
	CTemplateType* _this = (CTemplateType*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CType]]]', not an object.]]', not an object.]]', not an object.]*/ typeArguments = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CType]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CType]]]', not an object.]*/(iter_List(_this->list, ), F? { alloc(CType), F?Table { generate }}), new_Joiner(", "));
...
Option<R> next_MapHead(void* _ref){
	MapHead<T, R>* _this = (MapHead<T, R>*) _ref;
	return map_/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'JGenericType[base=Head, typeArguments=[Identifier[value=T]]]', not an object.]*/(next_Head(_this->head, ), _this->mapper);
}
...
Option<R> next_FlatMapHead(void* _ref){
	...
	while (true) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'JGenericType[base=Head, typeArguments=[Identifier[value=T]]]', not an object.]*/ maybeNext = next_Head(_this->head, );
		if (maybeNext.variant = ?.NoneVariant) 
			return new_None<R>();
		_this->maybeCurrent = map_/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'JGenericType[base=Head, typeArguments=[Identifier[value=T]]]', not an object.]*/(maybeNext, _this->mapper);
	}
}
...
char* generate_CDeclaration(void* _ref){
	...
	return template + generate_CType(_this->type, ) + " " + this.name;
}
...
CType toCType_JGenericType(void* _ref){
	JGenericType* _this = (JGenericType*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JType]]]', not an object.]]', not an object.]]', not an object.]*/ newTypeArguments = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JType]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JType]]]', not an object.]*/(iter_List(_this->typeArguments, ), F? { alloc(Main), F?Table { transformType }}), );
...
char* generate_CPointerAccess(void* _ref){
	CPointerAccess* _this = (CPointerAccess*) _ref;
	return generate_CExpression(_this->instance, ) + "->" + this.fieldName;
}
...
char* generate_CInvocation(void* _ref){
	CInvocation* _this = (CInvocation*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CExpression]]]]', not an object.]]', not an object.]]', not an object.]*/ joinedArguments = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CExpression]]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CExpression]]]]', not an object.]*/(iter_/*Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CExpression]]]*/(cArguments_CInvocation(this, ), ), F? { alloc(CAssignable), F?Table { generate }}), new_Joiner(", "));
	return generate_/*Not a functional type: Identifier[value=CExpression]*/(expression_CInvocation(this, ), ) + "(" + joinedArguments + ")";
}
...
Option<JDeclaration> resolveExpression_Environment(void* _ref, char* identifier){
	...
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]*/(iter_List(_this->frames, ), lambda7), F? { alloc(Option), F?Table { iter }}), );
}
template <typename T>
Tuple<Environment, T> within_Environment(void* _ref, F1R<Environment, Tuple<Environment, T>> supplier){
	Environment* _this = (Environment*) _ref;
...
Environment defineAllExpressions_Environment(void* _ref, List<JDeclaration> declarations){
	Environment* _this = (Environment*) _ref;
	return new_Environment(mapLast_List(_this->frames, lambda8));
}
...
Environment defineExpression_Environment(void* _ref, JDeclaration declaration){
	Environment* _this = (Environment*) _ref;
	return new_Environment(mapLast_List(_this->frames, lambda9));
}
Option<JObjectType> resolveCurrent_Environment(void* _ref){
	Environment* _this = (Environment*) _ref;
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]*/(iterReversed_List(_this->frames, ), F? { alloc(Frame), F?Table { toStructureType }}), F? { alloc(Option), F?Table { iter }}), );
}
...
Option<JObjectType> resolveType_Environment(void* _ref, char* name){
	Environment* _this = (Environment*) _ref;
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'JGenericType[base=List, typeArguments=[Identifier[value=Frame]]]', not an object.]*/(iterReversed_List(_this->frames, ), lambda11), F? { alloc(Option), F?Table { iter }}), );
}
...
Option<JDeclaration> resolveExpression_Frame(void* _ref, char* identifier){
	Frame* _this = (Frame*) _ref;
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JDeclaration]]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JDeclaration]]]', not an object.]*/(iter_List(_this->definedExpressions, ), lambda13), );
}
Frame defineExpression_Frame(void* _ref, JDeclaration declaration){
	Frame* _this = (Frame*) _ref;
...
Option<JObjectType> toStructureType_Frame(void* _ref){
	Frame* _this = (Frame*) _ref;
	return map_Option(_this->maybeObject, lambda14);
}
Frame withObject_Frame(void* _ref, JObject name){
	Frame* _this = (Frame*) _ref;
...
Option<JObjectType> resolveType_Frame(void* _ref, char* name){
	Frame* _this = (Frame*) _ref;
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JObjectType]]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JObjectType]]]', not an object.]*/(iter_List(_this->definedTypes, ), lambda15), );
}
Frame defineAllTypes_Frame(void* _ref, List<JObjectType> types){
	Frame* _this = (Frame*) _ref;
...
Option<JType> resolve_JObjectType(void* _ref, char* name){
	JObjectType* _this = (JObjectType*) _ref;
	return map_/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JDeclaration]]]', not an object.]]', not an object.]]', not an object.]*/(next_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JDeclaration]]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JDeclaration]]]', not an object.]*/(iter_List(_this->members, ), lambda16), ), F? { alloc(JDeclaration), F?Table { type }});
}
...
char* generate_CStructure(void* _ref){
	CStructure* _this = (CStructure*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ joinedFields = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]]', not an object.]*/(iter_/*Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]*/(fields_CStructure(this, ), ), F? { alloc(CField), F?Table { new }}), F? { alloc(CField), F?Table { generate }}), new_Joiner());
...
char* generate_CEnum(void* _ref){
	CEnum* _this = (CEnum*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ enumFields = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]', not an object.]*/(iter_/*Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]*/(variants_CEnum(this, ), ), lambda17), lambda18), new_Joiner(","));
...
char* generate_JUnion(void* _ref){
	JUnion* _this = (JUnion*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]', not an object.]]', not an object.]]', not an object.]*/ unionFields = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]', not an object.]*/(iter_/*Not a functional type: JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]*/(members_JUnion(this, ), ), F? { alloc(Main), F?Table { generateStatement }}), new_Joiner());
...
List<CFunction> createConversionFunctions_JObject(void* _ref){
	JObject* _this = (JObject*) _ref;
	return toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CType]]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CType]]]]', not an object.]*/(iter_/*Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CType]]]*/(implementees_JObject(this, ), ), F? { alloc(this), F?Table { createConversionType }}), );
}
CFunction createConversionType_JObject(void* _ref, CType implementee){
	JObject* _this = (JObject*) _ref;
...
char* generate_CFunctionHeader(void* _ref){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]]]', not an object.]]', not an object.]]', not an object.]*/ compiledParameters = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]]]', not an object.]*/(iter_/*Not a functional type: JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]]*/(parameters_CFunctionHeader(this, ), ), F? { alloc(CDeclaration), F?Table { generate }}), new_Joiner(", "));
	return generate_/*Not a functional type: Identifier[value=CFunctionDeclaration]*/(definition_CFunctionHeader(this, ), ) + "(" + compiledParameters + ")";
}
char* generate_CFunction(void* _ref){
	CFunction* _this = (CFunction*) _ref;
	return lineSeparator_/*Unwrapped expression: generate_startNot a functional type: Identifier[value=CFunctionHeader]end(header_CFunction(this, ), ) + "{" + content_CFunction(this, ) + lineSeparator_startUndefined identifier: Systemend(System, ) + "}" + System*/(generate_/*Not a functional type: Identifier[value=CFunctionHeader]*/(header_CFunction(this, ), ) + "{" + content_CFunction(this, ) + lineSeparator_/*Undefined identifier: System*/(System, ) + "}" + System, );
}
...
Option<JDeclaration> toDeclaration_JMethod(void* _ref){
	...
	if (_this->methodDeclaration.variant = ?.JDeclaration declarationVariant) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JDeclaration]]]', not an object.]]', not an object.]]', not an object.]*/ paramTypes = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JDeclaration]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=JDeclaration]]]', not an object.]*/(iter_List(_this->parameters, ), F? { alloc(JDeclaration), F?Table { type }}), );
...
char* generateTemplateString_Main(void* _ref, List<char*> typeParameters){
	...
	if (isEmpty_List(typeParameters, )) 
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ typeNames = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(iter_List(typeParameters, ), lambda19), new_Joiner(", "));
...
char* joinTypeParameters_Main(void* _ref, List<char*> typeParameters){
	...
	else joinedTypeParameters = " < " + collect_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(iter_List(typeParameters, ), new_Joiner(", ")) + ">";
...
CInvocation transformInvocation_Main(void* _ref, JInvokable jInvokable){
	...
	if (caller.variant = ?.JMemberAccess(var instance, var memberName)Variant) {
		if (instance.variant = ?.Identifier(var name)Variant) {
			/*Not a functional type: Placeholder[input=Cannot access member 'resolveType' in 'Placeholder[input=Member 'environment' not defined in 'JObjectType[name=Main, members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Identifier[value=new]], name='Environment'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='functionDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='globals'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]], name='rootSegments'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]], name='functions'}, JDeclaration {maybeBeforeType=private, type=Identifier[value=int], name='counter'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='generateTemplateString'}, JDeclaration {type=JFunctionalType[parameterTypes=[JArrayType[type=magma.Main$JRecursiveType@7f690630]], returnType=Void], name='main'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='generateIndent'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=CType]], name='transformType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JPrimitiveType]], returnType=Identifier[value=CType]], name='transformPrimitiveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectType]]]], name='extractType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=CExpression]], name='transformCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=CExpression]], name='transformExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JInvokable]], returnType=Identifier[value=CInvocation]], name='transformInvocation'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=IOError]]]], name='run'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compile'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinStrings'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='compileStatements'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]], Identifier[value=Folder]], returnType=magma.Main$JRecursiveType@7f690630], name='compileAll'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=Folder]], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='divide'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=State], Char], returnType=Identifier[value=State]], name='foldStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileRootSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObject]]]], name='parseObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='extractField'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject], Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObjectMemberPrototype'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JMethod], Identifier[value=JObject]], returnType=Identifier[value=CStructMember]], name='completeMethodProto'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseObjectMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[Identifier[value=CStructMember]]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]], name='retainFields'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]], name='flattenSealedStructure'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=CStructMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CDefinable]]]], name='retainDefinables'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='splitValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration], JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]], JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='computeMethodBody'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=CType], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='createBodyForAbstractMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='transformMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='convertToFunctionDeclarations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=Identifier[value=CType]], name='toConstructorReturnType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodsSegments'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateCase'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JMethodDeclaration]], name='parseMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JDeclaration]], returnType=Identifier[value=JMethodDeclaration]], name='toInterface'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JMethodDeclaration]]]], name='parseConstructor'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='compileEnumValue'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileConditional'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileAssignment'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JAssignable], Identifier[value=JExpression]], returnType=Identifier[value=CAssignable]], name='transformAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression], Identifier[value=JType]], returnType=Identifier[value=JType]], name='resolveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectType], Identifier[value=JType], magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='resolveMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=JType]], name='resolveCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JAssignable]], name='parseAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='post'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileExpressionOrPlaceholder'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CExpression]]]], name='parseCExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileLambda'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]]], name='parseLambdaParams'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@7f690630], name='generateName'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileOperator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseInvokable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findCallerStart'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isNumber'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='allDigits'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JCaller]]]], name='parseCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='parseDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='collectAnnotations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findTypeSeparator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='parseType'}]]']', not an object.]*/ maybeType = resolveType_/*Member 'environment' not defined in 'JObjectType[name=Main, members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Identifier[value=new]], name='Environment'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='functionDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='globals'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]], name='rootSegments'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]], name='functions'}, JDeclaration {maybeBeforeType=private, type=Identifier[value=int], name='counter'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='generateTemplateString'}, JDeclaration {type=JFunctionalType[parameterTypes=[JArrayType[type=magma.Main$JRecursiveType@7f690630]], returnType=Void], name='main'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='generateIndent'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=CType]], name='transformType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JPrimitiveType]], returnType=Identifier[value=CType]], name='transformPrimitiveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectType]]]], name='extractType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=CExpression]], name='transformCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=CExpression]], name='transformExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JInvokable]], returnType=Identifier[value=CInvocation]], name='transformInvocation'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=IOError]]]], name='run'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compile'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinStrings'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='compileStatements'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]], Identifier[value=Folder]], returnType=magma.Main$JRecursiveType@7f690630], name='compileAll'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=Folder]], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='divide'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=State], Char], returnType=Identifier[value=State]], name='foldStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileRootSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObject]]]], name='parseObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='extractField'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject], Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObjectMemberPrototype'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JMethod], Identifier[value=JObject]], returnType=Identifier[value=CStructMember]], name='completeMethodProto'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseObjectMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[Identifier[value=CStructMember]]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]], name='retainFields'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]], name='flattenSealedStructure'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=CStructMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CDefinable]]]], name='retainDefinables'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='splitValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration], JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]], JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='computeMethodBody'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=CType], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='createBodyForAbstractMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='transformMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='convertToFunctionDeclarations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=Identifier[value=CType]], name='toConstructorReturnType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodsSegments'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateCase'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JMethodDeclaration]], name='parseMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JDeclaration]], returnType=Identifier[value=JMethodDeclaration]], name='toInterface'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JMethodDeclaration]]]], name='parseConstructor'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='compileEnumValue'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileConditional'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileAssignment'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JAssignable], Identifier[value=JExpression]], returnType=Identifier[value=CAssignable]], name='transformAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression], Identifier[value=JType]], returnType=Identifier[value=JType]], name='resolveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectType], Identifier[value=JType], magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='resolveMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=JType]], name='resolveCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JAssignable]], name='parseAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='post'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileExpressionOrPlaceholder'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CExpression]]]], name='parseCExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileLambda'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]]], name='parseLambdaParams'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@7f690630], name='generateName'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileOperator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseInvokable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findCallerStart'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isNumber'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='allDigits'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JCaller]]]], name='parseCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='parseDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='collectAnnotations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findTypeSeparator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='parseType'}]]'*/(_this->environment, name);
...
char* compile_Main(void* _ref, char* input){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]', not an object.]]', not an object.]]', not an object.]*/ joinedStructures = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]', not an object.]*/(iter_List(_this->rootSegments, ), F? { alloc(CRootSegment), F?Table { generate }}), new_Joiner());
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]]', not an object.]]', not an object.]]', not an object.]*/ joinedFunctions = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]]', not an object.]*/(iter_List(_this->functions, ), F? { alloc(CFunction), F?Table { generate }}), new_Joiner());
	return joinedStructures + joinedGlobals + joinedFunctionDeclarations + joinedFunctions + all;
}
char* joinStrings_Main(void* _ref, List<char*> structures){
	Main* _this = (Main*) _ref;
	return collect_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(iter_List(structures, ), new_Joiner(""));
}
char* compileStatements_Main(void* _ref, char* input, F1R<char*, char*> mapper){
	Main* _this = (Main*) _ref;
...
char* compileAll_Main(void* _ref, char* input, F1R<char*, char*> mapper, Folder folder){
	Main* _this = (Main*) _ref;
	return collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, input, folder), mapper), new_Joiner(""));
}
Iter<char*> divide_Main(void* _ref, char* input, Folder folder){
	Main* _this = (Main*) _ref;
...
Option<JObject> parseObject_Main(void* _ref, char* type, char* stripped){
	...
	if (i4 >= 0) {
		...
		implementees = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, implementeesString, new_ValueFolder()), F? { alloc(String), F?Table { strip }}), lambda21), lambda22), );
	}
	...
	if (endsWith_char_ptr(beforeContent, ")")) {
		...
		if (i3 >= 0) {
			...
			recordFields = toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, substring_char_ptr(substring, i3 + 1), new_ValueFolder()), F? { alloc(this), F?Table { parseDeclaration }}), F? { alloc(Option), F?Table { iter }}), );
		}
	}
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ children = toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, inputContent, new_EscapedFolder(F? { alloc(this), F?Table { foldStatement }})), lambda24), F? { alloc(Option), F?Table { iter }}), );
...
/*?*/ lambda26(void* _ref, /*?*/ env){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'addAllLast' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Cannot access member 'children' in 'Identifier[value=JObject]', not an object.]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ declarations = addAllLast_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Cannot access member 'children' in 'Identifier[value=JObject]', not an object.]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Cannot access member 'children' in 'Identifier[value=JObject]', not an object.]', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Cannot access member 'children' in 'Identifier[value=JObject]', not an object.]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Cannot access member 'children' in 'Identifier[value=JObject]', not an object.]', not an object.]*/(iter_/*Cannot access member 'children' in 'Identifier[value=JObject]', not an object.*/(object.children, ), F? { alloc(this), F?Table { extractField }}), F? { alloc(Option), F?Table { iter }}), ), object.recordFields);
	_this->environment = defineAllTypes_/*Member 'environment' not defined in 'JObjectType[name=Main, members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Identifier[value=new]], name='Environment'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='functionDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='globals'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]], name='rootSegments'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]], name='functions'}, JDeclaration {maybeBeforeType=private, type=Identifier[value=int], name='counter'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='generateTemplateString'}, JDeclaration {type=JFunctionalType[parameterTypes=[JArrayType[type=magma.Main$JRecursiveType@7f690630]], returnType=Void], name='main'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='generateIndent'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=CType]], name='transformType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JPrimitiveType]], returnType=Identifier[value=CType]], name='transformPrimitiveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectType]]]], name='extractType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=CExpression]], name='transformCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=CExpression]], name='transformExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JInvokable]], returnType=Identifier[value=CInvocation]], name='transformInvocation'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=IOError]]]], name='run'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compile'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinStrings'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='compileStatements'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]], Identifier[value=Folder]], returnType=magma.Main$JRecursiveType@7f690630], name='compileAll'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=Folder]], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='divide'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=State], Char], returnType=Identifier[value=State]], name='foldStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileRootSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObject]]]], name='parseObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='extractField'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject], Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObjectMemberPrototype'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JMethod], Identifier[value=JObject]], returnType=Identifier[value=CStructMember]], name='completeMethodProto'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseObjectMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[Identifier[value=CStructMember]]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]], name='retainFields'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]], name='flattenSealedStructure'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=CStructMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CDefinable]]]], name='retainDefinables'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='splitValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration], JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]], JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='computeMethodBody'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=CType], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='createBodyForAbstractMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='transformMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='convertToFunctionDeclarations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=Identifier[value=CType]], name='toConstructorReturnType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodsSegments'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateCase'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JMethodDeclaration]], name='parseMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JDeclaration]], returnType=Identifier[value=JMethodDeclaration]], name='toInterface'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JMethodDeclaration]]]], name='parseConstructor'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='compileEnumValue'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileConditional'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileAssignment'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JAssignable], Identifier[value=JExpression]], returnType=Identifier[value=CAssignable]], name='transformAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression], Identifier[value=JType]], returnType=Identifier[value=JType]], name='resolveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectType], Identifier[value=JType], magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='resolveMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=JType]], name='resolveCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JAssignable]], name='parseAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='post'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileExpressionOrPlaceholder'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CExpression]]]], name='parseCExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileLambda'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]]], name='parseLambdaParams'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@7f690630], name='generateName'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileOperator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseInvokable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findCallerStart'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isNumber'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='allDigits'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JCaller]]]], name='parseCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='parseDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='collectAnnotations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findTypeSeparator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='parseType'}]]'*/(_this->environment, types);
	_this->environment = defineAllExpressions_/*Member 'environment' not defined in 'JObjectType[name=Main, members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Identifier[value=new]], name='Environment'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='functionDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='globals'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]], name='rootSegments'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]], name='functions'}, JDeclaration {maybeBeforeType=private, type=Identifier[value=int], name='counter'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='generateTemplateString'}, JDeclaration {type=JFunctionalType[parameterTypes=[JArrayType[type=magma.Main$JRecursiveType@7f690630]], returnType=Void], name='main'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='generateIndent'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=CType]], name='transformType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JPrimitiveType]], returnType=Identifier[value=CType]], name='transformPrimitiveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectType]]]], name='extractType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=CExpression]], name='transformCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=CExpression]], name='transformExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JInvokable]], returnType=Identifier[value=CInvocation]], name='transformInvocation'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=IOError]]]], name='run'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compile'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinStrings'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='compileStatements'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]], Identifier[value=Folder]], returnType=magma.Main$JRecursiveType@7f690630], name='compileAll'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=Folder]], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='divide'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=State], Char], returnType=Identifier[value=State]], name='foldStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileRootSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObject]]]], name='parseObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='extractField'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject], Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObjectMemberPrototype'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JMethod], Identifier[value=JObject]], returnType=Identifier[value=CStructMember]], name='completeMethodProto'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseObjectMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[Identifier[value=CStructMember]]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]], name='retainFields'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]], name='flattenSealedStructure'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=CStructMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CDefinable]]]], name='retainDefinables'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='splitValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration], JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]], JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='computeMethodBody'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=CType], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='createBodyForAbstractMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='transformMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='convertToFunctionDeclarations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=Identifier[value=CType]], name='toConstructorReturnType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodsSegments'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateCase'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JMethodDeclaration]], name='parseMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JDeclaration]], returnType=Identifier[value=JMethodDeclaration]], name='toInterface'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JMethodDeclaration]]]], name='parseConstructor'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='compileEnumValue'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileConditional'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileAssignment'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JAssignable], Identifier[value=JExpression]], returnType=Identifier[value=CAssignable]], name='transformAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression], Identifier[value=JType]], returnType=Identifier[value=JType]], name='resolveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectType], Identifier[value=JType], magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='resolveMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=JType]], name='resolveCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JAssignable]], name='parseAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='post'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileExpressionOrPlaceholder'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CExpression]]]], name='parseCExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileLambda'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]]], name='parseLambdaParams'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@7f690630], name='generateName'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileOperator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseInvokable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findCallerStart'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isNumber'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='allDigits'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JCaller]]]], name='parseCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='parseDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='collectAnnotations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findTypeSeparator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='parseType'}]]'*/(_this->environment, declarations);
...
CStructMember completeMethodProto_Main(void* _ref, JMethod jFunctionProto, JObject object){
	...
	if (endsWith_/*Cannot access member 'content' in 'Placeholder[input=Unwrapped expression: startsWith_startCannot access member 'content' in 'Identifier[value=JMethod]', not an object.end(jFunctionProto.content, "{") && jFunctionProto]', not an object.*/(startsWith_/*Cannot access member 'content' in 'Identifier[value=JMethod]', not an object.*/(jFunctionProto.content, "{") && jFunctionProto.content, "}")) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'within' in 'Placeholder[input=Member 'environment' not defined in 'JObjectType[name=Main, members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Identifier[value=new]], name='Environment'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='functionDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='globals'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]], name='rootSegments'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]], name='functions'}, JDeclaration {maybeBeforeType=private, type=Identifier[value=int], name='counter'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='generateTemplateString'}, JDeclaration {type=JFunctionalType[parameterTypes=[JArrayType[type=magma.Main$JRecursiveType@7f690630]], returnType=Void], name='main'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='generateIndent'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=CType]], name='transformType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JPrimitiveType]], returnType=Identifier[value=CType]], name='transformPrimitiveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectType]]]], name='extractType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=CExpression]], name='transformCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=CExpression]], name='transformExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JInvokable]], returnType=Identifier[value=CInvocation]], name='transformInvocation'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=IOError]]]], name='run'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compile'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinStrings'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='compileStatements'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]], Identifier[value=Folder]], returnType=magma.Main$JRecursiveType@7f690630], name='compileAll'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=Folder]], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='divide'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=State], Char], returnType=Identifier[value=State]], name='foldStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileRootSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObject]]]], name='parseObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='extractField'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject], Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObjectMemberPrototype'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JMethod], Identifier[value=JObject]], returnType=Identifier[value=CStructMember]], name='completeMethodProto'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseObjectMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[Identifier[value=CStructMember]]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]], name='retainFields'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]], name='flattenSealedStructure'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=CStructMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CDefinable]]]], name='retainDefinables'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='splitValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration], JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]], JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='computeMethodBody'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=CType], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='createBodyForAbstractMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='transformMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='convertToFunctionDeclarations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=Identifier[value=CType]], name='toConstructorReturnType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodsSegments'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateCase'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JMethodDeclaration]], name='parseMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JDeclaration]], returnType=Identifier[value=JMethodDeclaration]], name='toInterface'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JMethodDeclaration]]]], name='parseConstructor'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='compileEnumValue'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileConditional'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileAssignment'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JAssignable], Identifier[value=JExpression]], returnType=Identifier[value=CAssignable]], name='transformAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression], Identifier[value=JType]], returnType=Identifier[value=JType]], name='resolveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectType], Identifier[value=JType], magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='resolveMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=JType]], name='resolveCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JAssignable]], name='parseAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='post'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileExpressionOrPlaceholder'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CExpression]]]], name='parseCExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileLambda'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]]], name='parseLambdaParams'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@7f690630], name='generateName'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileOperator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseInvokable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findCallerStart'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isNumber'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='allDigits'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JCaller]]]], name='parseCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='parseDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='collectAnnotations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findTypeSeparator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='parseType'}]]']', not an object.]*/ within = within_/*Member 'environment' not defined in 'JObjectType[name=Main, members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Identifier[value=new]], name='Environment'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='functionDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], name='globals'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]], name='rootSegments'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]], name='functions'}, JDeclaration {maybeBeforeType=private, type=Identifier[value=int], name='counter'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='generateTemplateString'}, JDeclaration {type=JFunctionalType[parameterTypes=[JArrayType[type=magma.Main$JRecursiveType@7f690630]], returnType=Void], name='main'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='generateIndent'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=CType]], name='transformType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JPrimitiveType]], returnType=Identifier[value=CType]], name='transformPrimitiveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectType]]]], name='extractType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=CExpression]], name='transformCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=CExpression]], name='transformExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JInvokable]], returnType=Identifier[value=CInvocation]], name='transformInvocation'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=IOError]]]], name='run'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compile'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='joinStrings'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='compileStatements'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630]], Identifier[value=Folder]], returnType=magma.Main$JRecursiveType@7f690630], name='compileAll'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=Folder]], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='divide'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=State], Char], returnType=Identifier[value=State]], name='foldStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileRootSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObject]]]], name='parseObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='extractField'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject], Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObjectMemberPrototype'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JMethod], Identifier[value=JObject]], returnType=Identifier[value=CStructMember]], name='completeMethodProto'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseObjectMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[Identifier[value=CStructMember]]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]], name='retainFields'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]], name='flattenSealedStructure'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=CStructMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CDefinable]]]], name='retainDefinables'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='splitValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration], JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]], JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='computeMethodBody'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=CType], magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=magma.Main$JRecursiveType@7f690630], name='createBodyForAbstractMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='transformMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='convertToFunctionDeclarations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], returnType=Identifier[value=CType]], name='toConstructorReturnType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodsSegments'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='generateCase'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JMethodDeclaration]], name='parseMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JDeclaration]], returnType=Identifier[value=JMethodDeclaration]], name='toInterface'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JMethodDeclaration]]]], name='parseConstructor'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='compileEnumValue'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int]], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, Identifier[value=int], magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileConditional'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileMethodStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileAssignment'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JAssignable], Identifier[value=JExpression]], returnType=Identifier[value=CAssignable]], name='transformAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression], Identifier[value=JType]], returnType=Identifier[value=JType]], name='resolveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectType], Identifier[value=JType], magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='resolveMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=JType]], name='resolveCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JAssignable]], name='parseAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='post'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=magma.Main$JRecursiveType@7f690630], name='compileExpressionOrPlaceholder'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CExpression]]]], name='parseCExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileLambda'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]]]], name='parseLambdaParams'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@7f690630], name='generateName'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630, magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='compileOperator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseInvokable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findCallerStart'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='isNumber'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Boolean], name='allDigits'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JCaller]]]], name='parseCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='parseDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]], name='collectAnnotations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=int]], name='findTypeSeparator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@7f690630], returnType=Identifier[value=JType]], name='parseType'}]]'*/(_this->environment, lambda29);
		_this->environment = within.left;
...
Option<JObjectMember> parseMethod_Main(void* _ref, char* stripped, char* name, List<char*> typeParameters){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ parameters = toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/(toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, parametersString, new_ValueFolder()), F? { alloc(String), F?Table { strip }}), lambda30), ), ), F? { alloc(this), F?Table { parseDeclaration }}), F? { alloc(Option), F?Table { iter }}), );
...
List<CRootSegment> flattenSealedStructure_Main(void* _ref, char* name, List<char*> typeParameters, List<char*> variants){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ unionMembers = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(iter_List(variants, ), lambda33), );
...
List<char*> splitValues_Main(void* _ref, char* input){
	Main* _this = (Main*) _ref;
	/*Not a functional type: Placeholder[input=Member 'split' not defined in 'magma.Main$JRecursiveType@7f690630']*/ segments = split_char_ptr(input, quote_/*Undefined identifier: Pattern*/(Pattern, ","));
...
char* computeMethodBody_Main(void* _ref, List<char*> typeParameters, JMethodDeclaration methodDeclaration, List<CDeclaration> cParameters, Option<char*> maybeContent, char* structName, List<char*> structureVariants){
	...
	if (methodDeclaration.variant = ?.JConstructorVariant) {
		/*Not a functional type: Placeholder[input=Cannot access member 'orElse' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/ compiled = orElse_Option(maybeContent, "?");
	...
	if (methodDeclaration.variant = ?.JDeclaration declarationVariant) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'orElseGet' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/ body = orElseGet_Option(maybeContent, lambda37);
...
char* createBodyForAbstractMethod_Main(void* _ref, List<char*> variants, CType type, char* name, List<char*> parameterNames){
	...
	if (isEmpty_List(variants, )) {
		/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'addFirst' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ joinedParameters = collect_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'addFirst' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Cannot access member 'addFirst' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(addFirst_List(parameterNames, "_this->data"), ), new_Joiner(", "));
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ cases = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(iter_List(variants, ), lambda38), new_Joiner());
...
Option<JObjectMember> parseEnumValues_Main(void* _ref, char* input, char* structName){
	...
	if (endsWith_int(!stripped, ";")) 
		return new_None<JObjectMember>();
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ enumValues = toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, substring_char_ptr(stripped, 0, length_char_ptr(stripped, ) - 1), lambda44), F? { alloc(String), F?Table { strip }}), lambda45), );
	if (isEmpty_int(!enumValues, )) {
		/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ optionStream = map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/(enumValues, ), lambda46);
...
Option<char*> compileConditional_Main(void* _ref, char* type, int indent, char* input){
	...
	if (startsWith_char_ptr(input, type)) {
		...
		if (startsWith_char_ptr(substring, "(")) {
			...
			/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ divisions = toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, afterConditionStart, new_EscapedFolder(new_ConditionEndLocator())), F? { alloc(String), F?Table { strip }}), lambda47), );
			if (size_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/(divisions, ) < 2) 
				return new_None<char*>();
			/*Not a functional type: Placeholder[input=Cannot access member 'getFirst' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ first = getFirst_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/(divisions, );
			char* maybeWithBraces = joinStrings_Main(this, subList_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/(divisions, 1, size_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/(divisions, )));
			if (endsWith_int(!first, ")")) 
				return new_None<char*>();
			/*Not a functional type: Placeholder[input=Cannot access member 'substring' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'getFirst' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ condition = substring_/*Not a functional type: Placeholder[input=Cannot access member 'getFirst' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(first, 0, length_/*Not a functional type: Placeholder[input=Cannot access member 'getFirst' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(first, ) - 1);
...
Option<JExpression> parseExpression_Main(void* _ref, char* input){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ maybeOperator = or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(or_Option(compileOperator_Main(this, stripped, " == "), lambda50), lambda51), lambda52), lambda53), lambda54), lambda55), lambda56);
	if (maybeOperator.variant = ?.SomeVariant) 
		return map_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(maybeOperator, F? { alloc(JExpressionWrapper), F?Table { new }});
...
Option<List<char*>> parseLambdaParams_Main(void* _ref, char* input){
	...
	if (startsWith_char_ptr(input, "(") && input.endsWith(")")) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ list = toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, substring, new_ValueFolder()), F? { alloc(String), F?Table { strip }}), lambda58), );
...
Option<JExpression> parseInvokable_Main(void* _ref, char* stripped){
	...
	if (!(maybeCaller.variant = ?.Some(var value)Variant)) 
		return new_None<JExpression>();
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]]', not an object.]*/ arguments = toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, argumentsString, new_EscapedFolder(new_ValueFolder())), F? { alloc(this), F?Table { parseExpression }}), F? { alloc(Option), F?Table { iter }}), );
...
JType parseType_Main(void* _ref, char* input){
	...
	if (endsWith_char_ptr(stripped, ">")) {
		...
		if (i >= 0) {
			...
			/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]]', not an object.]*/ list = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@7f690630]]', not an object.]*/(map_Iter(divide_Main(this, parameters, new_ValueFolder()), F? { alloc(this), F?Table { parseType }}), );

...
StringBuilder appendChar_StringBuilder(void* _ref, char next){
	...
	return new_StringBuilder(addLast_/*Member 'list' not defined in 'JObjectType[name=StringBuilder, members=magma.Main$JavaList@4e515669]'*/(_this->list, next));
}
StringBuilder clear_StringBuilder(void* _ref){
	StringBuilder* _this = (StringBuilder*) _ref;
	return new_StringBuilder(clear_/*Member 'list' not defined in 'JObjectType[name=StringBuilder, members=magma.Main$JavaList@4e515669]'*/(_this->list, ));
}
char* toString_StringBuilder(void* _ref){
	StringBuilder* _this = (StringBuilder*) _ref;
	return collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'list' not defined in 'JObjectType[name=StringBuilder, members=magma.Main$JavaList@4e515669]']', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'list' not defined in 'JObjectType[name=StringBuilder, members=magma.Main$JavaList@4e515669]']', not an object.]*/(iter_/*Member 'list' not defined in 'JObjectType[name=StringBuilder, members=magma.Main$JavaList@4e515669]'*/(_this->list, ), F? { alloc(String), F?Table { valueOf }}), new_Joiner());
}
template <typename T, typename T>
Iter<T> of_Iter(void* _ref, T value){
...
R fold_Iter(void* _ref, R initial, F2R<R, T, R> folder){
	...
	while (true) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'toTuple' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'next' in 'Placeholder[input=Member 'head' not defined in 'JObjectType[name=Iter, members=magma.Main$JavaList@73a8dfcc]']', not an object.]]', not an object.]]', not an object.]*/ tuple = toTuple_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'next' in 'Placeholder[input=Member 'head' not defined in 'JObjectType[name=Iter, members=magma.Main$JavaList@73a8dfcc]']', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'Placeholder[input=Member 'head' not defined in 'JObjectType[name=Iter, members=magma.Main$JavaList@73a8dfcc]']', not an object.]*/(next_/*Member 'head' not defined in 'JObjectType[name=Iter, members=magma.Main$JavaList@73a8dfcc]'*/(_this->head, ), lambda0), lambda1);
		if (tuple.left) 
			current = tuple.right;
		return current;
	}
...
Option<T> next_Iter(void* _ref){
	Iter<T>* _this = (Iter<T>*) _ref;
	return next_/*Member 'head' not defined in 'JObjectType[name=Iter, members=magma.Main$JavaList@73a8dfcc]'*/(_this->head, );
}
...
Option<int> next_RangeHead(void* _ref){
	...
	if (_this->counter < this.length) {
		/*Member 'counter' not defined in 'JObjectType[name=RangeHead, members=magma.Main$JavaList@58d25a40]'*/ value = _this->counter;
		_this->counter++;
...
State append_State(void* _ref, char next){
	State* _this = (State*) _ref;
	_this->buffer = appendChar_/*Member 'buffer' not defined in 'JObjectType[name=State, members=magma.Main$JavaList@ee7d9f1]'*/(_this->buffer, next);
	return this;
}
Option<char> pop_State(void* _ref){
	State* _this = (State*) _ref;
...
State advance_State(void* _ref){
	State* _this = (State*) _ref;
	_this->segments = addLast_/*Member 'segments' not defined in 'JObjectType[name=State, members=magma.Main$JavaList@ee7d9f1]'*/(_this->segments, toString_/*Member 'buffer' not defined in 'JObjectType[name=State, members=magma.Main$JavaList@ee7d9f1]'*/(_this->buffer, ));
	_this->buffer = clear_/*Member 'buffer' not defined in 'JObjectType[name=State, members=magma.Main$JavaList@ee7d9f1]'*/(_this->buffer, );
	return this;
}
State enter_State(void* _ref){
	State* _this = (State*) _ref;
...
Iter<char*> stream_State(void* _ref){
	State* _this = (State*) _ref;
	return iter_/*Member 'segments' not defined in 'JObjectType[name=State, members=magma.Main$JavaList@ee7d9f1]'*/(_this->segments, );
}
...
Option<char> peek_State(void* _ref){
	State* _this = (State*) _ref;
	if (length_/*Cannot access member 'input' in 'Placeholder[input=Unwrapped expression: _this->index < this]', not an object.*/(_this->index < this.input, )) 
		return new_Some<char>(charAt_/*Member 'input' not defined in 'JObjectType[name=State, members=magma.Main$JavaList@ee7d9f1]'*/(_this->input, _this->index));
...
char* generate_CPointerType(void* _ref){
	CPointerType* _this = (CPointerType*) _ref;
	return generate_/*Member 'type' not defined in 'JObjectType[name=CPointerType, members=magma.Main$JavaList@15615099]'*/(_this->type, ) + "*";
}
char* toBaseName_CPointerType(void* _ref){
	CPointerType* _this = (CPointerType*) _ref;
	return toBaseName_/*Member 'type' not defined in 'JObjectType[name=CPointerType, members=magma.Main$JavaList@15615099]'*/(_this->type, ) + "_ptr";
}
...
char* generate_CTemplateType(void* _ref){
	CTemplateType* _this = (CTemplateType*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'list' not defined in 'JObjectType[name=CTemplateType, members=magma.Main$JavaList@368102c8]']', not an object.]]', not an object.]]', not an object.]*/ typeArguments = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'list' not defined in 'JObjectType[name=CTemplateType, members=magma.Main$JavaList@368102c8]']', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'list' not defined in 'JObjectType[name=CTemplateType, members=magma.Main$JavaList@368102c8]']', not an object.]*/(iter_/*Member 'list' not defined in 'JObjectType[name=CTemplateType, members=magma.Main$JavaList@368102c8]'*/(_this->list, ), F? { alloc(CType), F?Table { generate }}), new_Joiner(", "));
...
char* generate_FunctionDeclaration(void* _ref){
	...
	return generate_/*Member 'type' not defined in 'JObjectType[name=FunctionDeclaration, members=magma.Main$JavaList@1963006a]'*/(_this->type, ) + " (*" + this.name + ")" + joinedParameterTypes;
}
...
State apply_EscapedFolder(void* _ref, State state, char next){
	...
	return apply_/*Member 'folder' not defined in 'JObjectType[name=EscapedFolder, members=magma.Main$JavaList@7dc5e7b4]'*/(_this->folder, state, next);
}
...
char* generate_CField(void* _ref){
	CField* _this = (CField*) _ref;
	return generateStatement_/*Undefined identifier: Main*/(Main, 1, generate_/*Member 'declaration' not defined in 'JObjectType[name=CField, members=magma.Main$JavaList@1ee0005]'*/(_this->declaration, ));
}
...
Option<R> next_MapHead(void* _ref){
	MapHead<T, R>* _this = (MapHead<T, R>*) _ref;
	return map_/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'Placeholder[input=Member 'head' not defined in 'JObjectType[name=MapHead, members=magma.Main$JavaList@75a1cd57]']', not an object.]*/(next_/*Member 'head' not defined in 'JObjectType[name=MapHead, members=magma.Main$JavaList@75a1cd57]'*/(_this->head, ), _this->mapper);
}
...
Option<R> next_FlatMapHead(void* _ref){
	...
	while (true) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'Placeholder[input=Member 'head' not defined in 'JObjectType[name=FlatMapHead, members=magma.Main$JavaList@3d012ddd]']', not an object.]*/ maybeNext = next_/*Member 'head' not defined in 'JObjectType[name=FlatMapHead, members=magma.Main$JavaList@3d012ddd]'*/(_this->head, );
		if (maybeNext.variant = ?.NoneVariant) 
			return new_None<R>();
		_this->maybeCurrent = map_/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'Placeholder[input=Member 'head' not defined in 'JObjectType[name=FlatMapHead, members=magma.Main$JavaList@3d012ddd]']', not an object.]*/(maybeNext, _this->mapper);
	}
}
...
char* generate_CDeclaration(void* _ref){
	...
	return template + generate_/*Member 'type' not defined in 'JObjectType[name=CDeclaration, members=magma.Main$JavaList@6f2b958e]'*/(_this->type, ) + " " + this.name;
}
...
CType toCType_JGenericType(void* _ref){
	JGenericType* _this = (JGenericType*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'typeArguments' not defined in 'JObjectType[name=JGenericType, members=magma.Main$JavaList@1eb44e46]']', not an object.]]', not an object.]]', not an object.]*/ newTypeArguments = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'typeArguments' not defined in 'JObjectType[name=JGenericType, members=magma.Main$JavaList@1eb44e46]']', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'typeArguments' not defined in 'JObjectType[name=JGenericType, members=magma.Main$JavaList@1eb44e46]']', not an object.]*/(iter_/*Member 'typeArguments' not defined in 'JObjectType[name=JGenericType, members=magma.Main$JavaList@1eb44e46]'*/(_this->typeArguments, ), F? { alloc(Main), F?Table { transformType }}), );
...
char* generate_CPointerAccess(void* _ref){
	CPointerAccess* _this = (CPointerAccess*) _ref;
	return generate_/*Member 'instance' not defined in 'JObjectType[name=CPointerAccess, members=magma.Main$JavaList@6504e3b2]'*/(_this->instance, ) + "->" + this.fieldName;
}
...
char* generate_CFieldAccess(void* _ref){
	CFieldAccess* _this = (CFieldAccess*) _ref;
	return generate_/*Member 'instance' not defined in 'JObjectType[name=CFieldAccess, members=magma.Main$JavaList@515f550a]'*/(_this->instance, ) + "." + this.fieldName;
}
...
char* generate_CInvocation(void* _ref){
	CInvocation* _this = (CInvocation*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'cArguments' not defined in 'JObjectType[name=CInvocation, members=magma.Main$JavaList@626b2d4a]']]', not an object.]]', not an object.]]', not an object.]*/ joinedArguments = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'cArguments' not defined in 'JObjectType[name=CInvocation, members=magma.Main$JavaList@626b2d4a]']]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'cArguments' not defined in 'JObjectType[name=CInvocation, members=magma.Main$JavaList@626b2d4a]']]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Member 'cArguments' not defined in 'JObjectType[name=CInvocation, members=magma.Main$JavaList@626b2d4a]']*/(cArguments_CInvocation(this, ), ), F? { alloc(CAssignable), F?Table { generate }}), new_Joiner(", "));
	return generate_/*Not a functional type: Placeholder[input=Member 'expression' not defined in 'JObjectType[name=CInvocation, members=magma.Main$JavaList@626b2d4a]']*/(expression_CInvocation(this, ), ) + "(" + joinedArguments + ")";
}
...
Option<JDeclaration> resolveExpression_Environment(void* _ref, char* identifier){
	...
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]*/(iter_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, ), lambda7), F? { alloc(Option), F?Table { iter }}), );
}
template <typename T>
Tuple<Environment, T> within_Environment(void* _ref, F1R<Environment, Tuple<Environment, T>> supplier){
	Environment* _this = (Environment*) _ref;
	Environment withLastEnv = enter_Environment(this, );
	/*Not a functional type: Placeholder[input=Cannot access member 'apply' in 'JGenericType[base=F1R, typeArguments=magma.Main$JavaList@1c4af82c]', not an object.]*/ result = apply_F1R(supplier, withLastEnv);
	/*Not a functional type: Placeholder[input=Cannot access member 'exit' in 'Placeholder[input=Cannot access member 'left' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'apply' in 'JGenericType[base=F1R, typeArguments=magma.Main$JavaList@1c4af82c]', not an object.]]', not an object.]', not an object.]*/ exited = exit_/*Cannot access member 'left' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'apply' in 'JGenericType[base=F1R, typeArguments=magma.Main$JavaList@1c4af82c]', not an object.]]', not an object.*/(result.left, );
	return new_Tuple<Environment, T>(exited, result.right);
}
Environment exit_Environment(void* _ref){
	Environment* _this = (Environment*) _ref;
	return new_Environment(removeLast_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, ));
}
Environment enter_Environment(void* _ref){
	Environment* _this = (Environment*) _ref;
	return new_Environment(addLast_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, new_Frame()));
}
...
Environment defineAllExpressions_Environment(void* _ref, List<JDeclaration> declarations){
	Environment* _this = (Environment*) _ref;
	return new_Environment(mapLast_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, lambda8));
}
...
Environment defineExpression_Environment(void* _ref, JDeclaration declaration){
	Environment* _this = (Environment*) _ref;
	return new_Environment(mapLast_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, lambda9));
}
Option<JObjectType> resolveCurrent_Environment(void* _ref){
	Environment* _this = (Environment*) _ref;
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]*/(iterReversed_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, ), F? { alloc(Frame), F?Table { toStructureType }}), F? { alloc(Option), F?Table { iter }}), );
}
...
Environment withObject_Environment(void* _ref, JObject object){
	Environment* _this = (Environment*) _ref;
	return new_Environment(mapLast_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, lambda10));
}
...
Option<JObjectType> resolveType_Environment(void* _ref, char* name){
	Environment* _this = (Environment*) _ref;
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iterReversed' in 'Placeholder[input=Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]']', not an object.]*/(iterReversed_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, ), lambda11), F? { alloc(Option), F?Table { iter }}), );
}
...
Environment defineAllTypes_Environment(void* _ref, List<JObjectType> types){
	Environment* _this = (Environment*) _ref;
	return new_Environment(mapLast_/*Member 'frames' not defined in 'JObjectType[name=Environment, members=magma.Main$JavaList@5e91993f]'*/(_this->frames, lambda12));
}
/*private List<JObjectType> types = new JavaList<JObjectType>*/(){?
}
Frame<> new_Frame(Option<JObject> maybeName, List<JDeclaration> defined){
...
Frame defineAll_Frame(void* _ref, List<JDeclaration> declarations){
	...
	return new_Frame(_this->maybeObject, addAllLast_/*Member 'definitions' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]'*/(_this->definitions, declarations));
}
/*?*/ lambda13(void* _ref, /*?*/ define){
	return equals_/*Cannot access member 'name' in 'JFunctionalType[parameterTypes=magma.Main$JavaList@cac736f, returnType=Identifier[value=Frame]]', not an object.*/(define.name, identifier);
}
Option<JDeclaration> resolveExpression_Frame(void* _ref, char* identifier){
	Frame* _this = (Frame*) _ref;
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'definitions' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]']', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'definitions' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]']', not an object.]*/(iter_/*Member 'definitions' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]'*/(_this->definitions, ), lambda13), );
}
Frame define_Frame(void* _ref, JDeclaration declaration){
	Frame* _this = (Frame*) _ref;
	_this->definitions = addLast_/*Member 'definitions' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]'*/(_this->definitions, declaration);
	return this;
}
...
Option<JObjectType> toStructureType_Frame(void* _ref){
	Frame* _this = (Frame*) _ref;
	return map_/*Member 'maybeObject' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]'*/(_this->maybeObject, lambda14);
}
Frame withObject_Frame(void* _ref, JObject name){
	Frame* _this = (Frame*) _ref;
...
Option<JObjectType> resolveType_Frame(void* _ref, char* name){
	Frame* _this = (Frame*) _ref;
	return next_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'types' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]']', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'types' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]']', not an object.]*/(iter_/*Member 'types' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]'*/(_this->types, ), lambda15), );
}
Frame defineAllTypes_Frame(void* _ref, List<JObjectType> types){
	Frame* _this = (Frame*) _ref;
	_this->types = addAllLast_/*Member 'types' not defined in 'JObjectType[name=Frame, members=magma.Main$JavaList@379619aa]'*/(_this->types, types);
	return this;
}
...
Option<JType> resolve_JObjectType(void* _ref, char* name){
	JObjectType* _this = (JObjectType*) _ref;
	return map_/*Not a functional type: Placeholder[input=Cannot access member 'next' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'members' not defined in 'JObjectType[name=JObjectType, members=magma.Main$JavaList@5e265ba4]']', not an object.]]', not an object.]]', not an object.]*/(next_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'members' not defined in 'JObjectType[name=JObjectType, members=magma.Main$JavaList@5e265ba4]']', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'members' not defined in 'JObjectType[name=JObjectType, members=magma.Main$JavaList@5e265ba4]']', not an object.]*/(iter_/*Member 'members' not defined in 'JObjectType[name=JObjectType, members=magma.Main$JavaList@5e265ba4]'*/(_this->members, ), lambda16), ), F? { alloc(JDeclaration), F?Table { type }});
}
...
JType create_JRecursiveType(void* _ref, F1R<JType, JType> mapper){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'apply' in 'JGenericType[base=F1R, typeArguments=magma.Main$JavaList@156643d4]', not an object.]*/ apply = apply_F1R(mapper, created);
...
char* generate_CStructure(void* _ref){
	CStructure* _this = (CStructure*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'fields' not defined in 'JObjectType[name=CStructure, members=magma.Main$JavaList@123a439b]']]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ joinedFields = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'fields' not defined in 'JObjectType[name=CStructure, members=magma.Main$JavaList@123a439b]']]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'fields' not defined in 'JObjectType[name=CStructure, members=magma.Main$JavaList@123a439b]']]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'fields' not defined in 'JObjectType[name=CStructure, members=magma.Main$JavaList@123a439b]']]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Member 'fields' not defined in 'JObjectType[name=CStructure, members=magma.Main$JavaList@123a439b]']*/(fields_CStructure(this, ), ), F? { alloc(CField), F?Table { new }}), F? { alloc(CField), F?Table { generate }}), new_Joiner());
...
char* generate_CEnum(void* _ref){
	CEnum* _this = (CEnum*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'variants' not defined in 'JObjectType[name=CEnum, members=magma.Main$JavaList@7de26db8]']]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ enumFields = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'variants' not defined in 'JObjectType[name=CEnum, members=magma.Main$JavaList@7de26db8]']]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'variants' not defined in 'JObjectType[name=CEnum, members=magma.Main$JavaList@7de26db8]']]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'variants' not defined in 'JObjectType[name=CEnum, members=magma.Main$JavaList@7de26db8]']]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Member 'variants' not defined in 'JObjectType[name=CEnum, members=magma.Main$JavaList@7de26db8]']*/(variants_CEnum(this, ), ), lambda17), lambda18), new_Joiner(","));
...
char* generate_JUnion(void* _ref){
	JUnion* _this = (JUnion*) _ref;
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'members' not defined in 'JObjectType[name=JUnion, members=magma.Main$JavaList@1175e2db]']]', not an object.]]', not an object.]]', not an object.]*/ unionFields = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'members' not defined in 'JObjectType[name=JUnion, members=magma.Main$JavaList@1175e2db]']]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'members' not defined in 'JObjectType[name=JUnion, members=magma.Main$JavaList@1175e2db]']]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Member 'members' not defined in 'JObjectType[name=JUnion, members=magma.Main$JavaList@1175e2db]']*/(members_JUnion(this, ), ), F? { alloc(Main), F?Table { generateStatement }}), new_Joiner());
...
List<CFunction> createConversionFunctions_JObject(void* _ref){
	JObject* _this = (JObject*) _ref;
	return toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'implementees' not defined in 'JObjectType[name=JObject, members=magma.Main$JavaList@36aa7bc2]']]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'implementees' not defined in 'JObjectType[name=JObject, members=magma.Main$JavaList@36aa7bc2]']]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Member 'implementees' not defined in 'JObjectType[name=JObject, members=magma.Main$JavaList@36aa7bc2]']*/(implementees_JObject(this, ), ), F? { alloc(this), F?Table { createConversionType }}), );
}
CFunction createConversionType_JObject(void* _ref, CType implementee){
	JObject* _this = (JObject*) _ref;
...
char* generate_CFunctionHeader(void* _ref){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'parameters' not defined in 'JObjectType[name=CFunctionHeader, members=magma.Main$JavaList@76ccd017]']]', not an object.]]', not an object.]]', not an object.]*/ compiledParameters = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'parameters' not defined in 'JObjectType[name=CFunctionHeader, members=magma.Main$JavaList@76ccd017]']]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Member 'parameters' not defined in 'JObjectType[name=CFunctionHeader, members=magma.Main$JavaList@76ccd017]']]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Member 'parameters' not defined in 'JObjectType[name=CFunctionHeader, members=magma.Main$JavaList@76ccd017]']*/(parameters_CFunctionHeader(this, ), ), F? { alloc(CDeclaration), F?Table { generate }}), new_Joiner(", "));
	return generate_/*Not a functional type: Placeholder[input=Member 'definition' not defined in 'JObjectType[name=CFunctionHeader, members=magma.Main$JavaList@76ccd017]']*/(definition_CFunctionHeader(this, ), ) + "(" + compiledParameters + ")";
}
char* generate_CFunction(void* _ref){
	CFunction* _this = (CFunction*) _ref;
	return lineSeparator_/*Unwrapped expression: generate_startNot a functional type: Placeholder[input=Member 'header' not defined in 'JObjectType[name=CFunction, members=magma.Main$JavaList@182decdb]']end(header_CFunction(this, ), ) + "{" + content_CFunction(this, ) + lineSeparator_startUndefined identifier: Systemend(System, ) + "}" + System*/(generate_/*Not a functional type: Placeholder[input=Member 'header' not defined in 'JObjectType[name=CFunction, members=magma.Main$JavaList@182decdb]']*/(header_CFunction(this, ), ) + "{" + content_CFunction(this, ) + lineSeparator_/*Undefined identifier: System*/(System, ) + "}" + System, );
}
...
Option<JDeclaration> toDeclaration_JMethod(void* _ref){
	...
	if (_this->methodDeclaration.variant = ?.JDeclaration declarationVariant) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'parameters' not defined in 'JObjectType[name=JMethod, members=magma.Main$JavaList@26f0a63f]']', not an object.]]', not an object.]]', not an object.]*/ paramTypes = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'parameters' not defined in 'JObjectType[name=JMethod, members=magma.Main$JavaList@26f0a63f]']', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Member 'parameters' not defined in 'JObjectType[name=JMethod, members=magma.Main$JavaList@26f0a63f]']', not an object.]*/(iter_/*Member 'parameters' not defined in 'JObjectType[name=JMethod, members=magma.Main$JavaList@26f0a63f]'*/(_this->parameters, ), F? { alloc(JDeclaration), F?Table { type }}), );
...
char* generateTemplateString_Main(void* _ref, List<char*> typeParameters){
	...
	if (isEmpty_List(typeParameters, )) 
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@4361bd48]', not an object.]]', not an object.]]', not an object.]*/ typeNames = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@4361bd48]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@4361bd48]', not an object.]*/(iter_List(typeParameters, ), lambda19), new_Joiner(", "));
...
char* joinTypeParameters_Main(void* _ref, List<char*> typeParameters){
	...
	else joinedTypeParameters = " < " + collect_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@2401f4c3]', not an object.]*/(iter_List(typeParameters, ), new_Joiner(", ")) + ">";
...
char* compileAll_Main(void* _ref, char* input, F1R<char*, char*> mapper, Folder folder){
	Main* _this = (Main*) _ref;
	return collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, input, folder), mapper), new_Joiner(""));
}
Iter<char*> divide_Main(void* _ref, char* input, Folder folder){
	Main* _this = (Main*) _ref;
...
Option<JObject> parseObject_Main(void* _ref, char* type, char* stripped){
	...
	if (i4 >= 0) {
		...
		implementees = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, implementeesString, new_ValueFolder()), F? { alloc(String), F?Table { strip }}), lambda21), lambda22), );
	}
	...
	if (endsWith_char_ptr(beforeContent, ")")) {
		...
		if (i3 >= 0) {
			...
			recordFields = toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, substring_char_ptr(substring, i3 + 1), new_ValueFolder()), F? { alloc(this), F?Table { parseDeclaration }}), F? { alloc(Option), F?Table { iter }}), );
		}
	}
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/ children = toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, inputContent, new_EscapedFolder(F? { alloc(this), F?Table { foldStatement }})), lambda24), F? { alloc(Option), F?Table { iter }}), );
...
/*?*/ lambda26(void* _ref, /*?*/ env){
	...
	_this->environment = defineAllTypes_/*Member 'environment' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]'*/(_this->environment, types);
	_this->environment = defineAllExpressions_/*Member 'environment' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]'*/(_this->environment, declarations);
...
Option<CStructMember> transformObject_Main(void* _ref, JObject object){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'within' in 'Placeholder[input=Member 'environment' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]']', not an object.]*/ within = within_/*Member 'environment' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]'*/(_this->environment, lambda26);
	_this->environment = within.left;
	/*Cannot access member 'right' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'within' in 'Placeholder[input=Member 'environment' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]']', not an object.]]', not an object.*/ members = within.right;
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'addLast' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@65ae6ba4]', not an object.]*/ elements = addLast_List(dependencies, new_CStructure(typeParameters_JObject(object, ), name_JObject(object, ), fields));
	_this->rootSegments = addAllLast_/*Member 'rootSegments' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]'*/(_this->rootSegments, elements);
	return new_Some<CStructMember>(new_EmptyStructMember());
}
Option<JDeclaration> extractMethodDeclaration_Main(void* _ref, JObjectMember prototype){
	Main* _this = (Main*) _ref;
...
CStructMember completeMethodProto_Main(void* _ref, JMethod jFunctionProto, JObject object){
	...
	_this->functionDeclarations = addLast_/*Member 'functionDeclarations' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]'*/(_this->functionDeclarations, lineSeparator_/*Unwrapped expression: generate_CFunctionHeader(header, ) + ";" + System*/(generate_CFunctionHeader(header, ) + ";" + System, ));
	_this->functions = addLast_/*Member 'functions' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]'*/(_this->functions, cFunction);
...
Option<JObjectMember> parseObjectMember_Main(void* _ref, char* input, char* name, List<char*> typeParameters){
	...
	if (endsWith_char_ptr(stripped, ";")) {
		...
		if (maybeDeclaration.variant = ?.SomeVariant) {
			_this->environment = defineExpression_/*Member 'environment' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]'*/(_this->environment, declaration);
...
Option<JObjectMember> parseMethod_Main(void* _ref, char* stripped, char* name, List<char*> typeParameters){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ parameters = toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/(toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, parametersString, new_ValueFolder()), F? { alloc(String), F?Table { strip }}), lambda30), ), ), F? { alloc(this), F?Table { parseDeclaration }}), F? { alloc(Option), F?Table { iter }}), );
...
List<CDefinable> retainFields_Main(void* _ref, List<CStructMember> members){
	Main* _this = (Main*) _ref;
	return toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@48cf768c]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@48cf768c]', not an object.]]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@48cf768c]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@48cf768c]', not an object.]*/(iter_List(members, ), F? { alloc(this), F?Table { retainDefinables }}), F? { alloc(Option), F?Table { iter }}), lambda31), );
}
...
List<CRootSegment> flattenSealedStructure_Main(void* _ref, char* name, List<char*> typeParameters, List<char*> variants){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@59f95c5d]', not an object.]]', not an object.]]', not an object.]*/ unionMembers = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@59f95c5d]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@59f95c5d]', not an object.]*/(iter_List(variants, ), lambda32), );
...
List<char*> splitValues_Main(void* _ref, char* input){
	Main* _this = (Main*) _ref;
	/*Not a functional type: Placeholder[input=Member 'split' not defined in 'magma.Main$JRecursiveType@6996db8']*/ segments = split_char_ptr(input, quote_/*Undefined identifier: Pattern*/(Pattern, ","));
...
/*?*/ lambda36(void* _ref){
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'subList' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@4aa8f0b4]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ list = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'subList' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@4aa8f0b4]', not an object.]]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'subList' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@4aa8f0b4]', not an object.]]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Cannot access member 'subList' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@4aa8f0b4]', not an object.]*/(subList_List(cParameters, 1, size_List(cParameters, )), ), lambda35), );
...
char* computeMethodBody_Main(void* _ref, List<char*> typeParameters, JMethodDeclaration methodDeclaration, List<CDeclaration> cParameters, Option<char*> maybeContent, char* structName, List<char*> structureVariants){
	...
	if (methodDeclaration.variant = ?.JConstructorVariant) {
		/*Not a functional type: Placeholder[input=Cannot access member 'orElse' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@5ccd43c2]', not an object.]*/ compiled = orElse_Option(maybeContent, "?");
	...
	if (methodDeclaration.variant = ?.JDeclaration declarationVariant) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'orElseGet' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@5ccd43c2]', not an object.]*/ body = orElseGet_Option(maybeContent, lambda36);
...
char* createBodyForAbstractMethod_Main(void* _ref, List<char*> variants, CType type, char* name, List<char*> parameterNames){
	...
	if (isEmpty_List(variants, )) {
		/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'addFirst' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@7960847b]', not an object.]]', not an object.]]', not an object.]*/ joinedParameters = collect_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'addFirst' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@7960847b]', not an object.]]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Cannot access member 'addFirst' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@7960847b]', not an object.]*/(addFirst_List(parameterNames, "_this->data"), ), new_Joiner(", "));
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@6a6824be]', not an object.]]', not an object.]]', not an object.]*/ cases = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@6a6824be]', not an object.]]', not an object.]*/(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'JGenericType[base=List, typeArguments=magma.Main$JavaList@6a6824be]', not an object.]*/(iter_List(variants, ), lambda37), new_Joiner());
...
JMethodDeclaration parseMethodDeclaration_Main(void* _ref, char* declaration, char* structName){
	Main* _this = (Main*) _ref;
	return orElseGet_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@5c8da962]', not an object.]*/(or_Option(parseConstructor_Main(this, declaration, structName), lambda41), lambda42);
}
JMethodDeclaration toInterface_Main(void* _ref, JDeclaration value){
	Main* _this = (Main*) _ref;
	return value;
...
Option<JObjectMember> parseEnumValues_Main(void* _ref, char* input, char* structName){
	...
	if (endsWith_int(!stripped, ";")) 
		return new_None<JObjectMember>();
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/ enumValues = toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, substring_char_ptr(stripped, 0, length_char_ptr(stripped, ) - 1), lambda43), F? { alloc(String), F?Table { strip }}), lambda44), );
	if (isEmpty_int(!enumValues, )) {
		/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ optionStream = map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(iter_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/(enumValues, ), lambda45);
...
Option<CStructMember> compileEnumValue_Main(void* _ref, char* structName, char* enumValue){
	...
	if (endsWith_char_ptr(enumValue, ")")) {
		...
		if (i >= 0) {
			...
			_this->globals = addLast_/*Member 'globals' not defined in 'JObjectType[name=Main, members=magma.Main$JavaList@5fdef03a]'*/(_this->globals, generated);
			return new_Some<CStructMember>(new_EmptyStructMember());
		}
	}
	return new_None<CStructMember>();
...
Option<char*> compileConditional_Main(void* _ref, char* type, int indent, char* input){
	...
	if (startsWith_char_ptr(input, type)) {
		...
		if (startsWith_char_ptr(substring, "(")) {
			...
			/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/ divisions = toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, afterConditionStart, new_EscapedFolder(new_ConditionEndLocator())), F? { alloc(String), F?Table { strip }}), lambda46), );
			if (size_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/(divisions, ) < 2) 
				return new_None<char*>();
			/*Not a functional type: Placeholder[input=Cannot access member 'getFirst' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ first = getFirst_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/(divisions, );
			char* maybeWithBraces = joinStrings_Main(this, subList_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/(divisions, 1, size_/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/(divisions, )));
			if (endsWith_int(!first, ")")) 
				return new_None<char*>();
			/*Not a functional type: Placeholder[input=Cannot access member 'substring' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'getFirst' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ condition = substring_/*Not a functional type: Placeholder[input=Cannot access member 'getFirst' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(first, 0, length_/*Not a functional type: Placeholder[input=Cannot access member 'getFirst' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(first, ) - 1);
...
char* compileExpressionOrPlaceholder_Main(void* _ref, char* input){
	Main* _this = (Main*) _ref;
	return orElseGet_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@512ddf17]', not an object.]*/(map_Option(parseCExpression_Main(this, input), F? { alloc(CExpression), F?Table { generate }}), lambda48);
}
Option<CExpression> parseCExpression_Main(void* _ref, char* input){
	Main* _this = (Main*) _ref;
...
Option<JExpression> parseExpression_Main(void* _ref, char* input){
	...
	if (i3 >= 0) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@512ddf17]', not an object.]*/ maybeInstance = map_Option(parseCExpression_Main(this, substring), F? { alloc(CExpression), F?Table { generate }});
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@2c13da15]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ maybeOperator = or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@2c13da15]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@2c13da15]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@2c13da15]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@2c13da15]', not an object.]]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@2c13da15]', not an object.]]', not an object.]*/(or_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@2c13da15]', not an object.]*/(or_Option(compileOperator_Main(this, stripped, " == "), lambda49), lambda50), lambda51), lambda52), lambda53), lambda54), lambda55);
	if (maybeOperator.variant = ?.SomeVariant) 
		return map_/*Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'or' in 'JGenericType[base=Option, typeArguments=magma.Main$JavaList@2c13da15]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(maybeOperator, F? { alloc(JExpressionWrapper), F?Table { new }});
...
Option<List<char*>> parseLambdaParams_Main(void* _ref, char* input){
	...
	if (startsWith_char_ptr(input, "(") && input.endsWith(")")) {
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/ list = toList_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/(filter_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, substring, new_ValueFolder()), F? { alloc(String), F?Table { strip }}), lambda57), );
...
Option<JExpression> parseInvokable_Main(void* _ref, char* stripped){
	...
	if (!(maybeCaller.variant = ?.Some(var value)Variant)) 
		return new_None<JExpression>();
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]]', not an object.]*/ arguments = toList_/*Not a functional type: Placeholder[input=Cannot access member 'flatMap' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/(flatMap_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, argumentsString, new_EscapedFolder(new_ValueFolder())), F? { alloc(this), F?Table { parseExpression }}), F? { alloc(Option), F?Table { iter }}), );
...
JType parseType_Main(void* _ref, char* input){
	...
	if (endsWith_char_ptr(stripped, ">")) {
		...
		if (i >= 0) {
			...
			/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]]', not an object.]*/ list = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'JGenericType[base=Iter, typeArguments=magma.Main$JavaList@1e81f4dc]', not an object.]*/(map_Iter(divide_Main(this, parameters, new_ValueFolder()), F? { alloc(this), F?Table { parseType }}), );

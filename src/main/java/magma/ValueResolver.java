...
public class ValueResolver {
	...
	public static Declaration resolveIdentifier(String s, Map<String, VarInfo> env, String stmt) throws CompileException {
	...
	public static Declaration resolveTypeSuffixedNumericLiteral(String s, String stmt) throws CompileException {

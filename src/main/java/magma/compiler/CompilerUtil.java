...
public final class CompilerUtil {
  ...
  public static Err<Set<Unit>, CompileError> handleThenElseAssignment(Compiler self, String lhsThen, String lhsElse,
      List<VarDecl> decls, Map<String, Boolean> assigned) {

...
public record ParseResult(List<VarDecl> decls, List<String> stmts, String last, List<SeqItem> seq) {
	...
	if (!Objects.equals(this.decls, other.decls())) return false;
	if (!Objects.equals(this.stmts, other.stmts())) return false;
	if (!Objects.equals(this.last, other.last())) return false;

...
/*Not a functional type: Placeholder[input=Member 'equals' not defined in 'magma.Main$JRecursiveType@79698539']*/ lambda19(void* _ref, JDeclaration define){
...
/*Not a functional type: Placeholder[input=Member 'equals' not defined in 'magma.Main$JRecursiveType@79698539']*/ lambda21(void* _ref, JObjectType type){
...
/*Not a functional type: Placeholder[input=Member 'equals' not defined in 'magma.Main$JRecursiveType@79698539']*/ lambda22(void* _ref, JDeclaration member){
...
char* generate_CFunctionHeader(void* _ref){
	...
	return generate_/*Not a functional type: JObjectType[name=CDefinable, variants=[CDeclaration, CFunctionDeclaration, Placeholder], members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@79698539], name='generate'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='extractIdentifiers'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]]]], returnType=Identifier[value=CDefinable]], name='mapTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@79698539, magma.Main$JRecursiveType@79698539]]], returnType=Identifier[value=CDefinable]], name='mapName'}], typeParameters=[]]*/(&(definition_CFunctionHeader(&((*_this))))) + "(" + compiledParameters + ")";
}
...
Option<IOError> run_Main(void* _ref){
	Main* _this = (Main*) _ref;
	Path source = resolve_Path(&(resolve_Path(&(resolve_Path(&(resolve_Path(&(resolve_Path(&(get_Paths(&(Paths), ".")), "src")), "main")), "java")), "magma")), "Main.java");
	Path target = resolve_Path(&(resolve_Path(&(resolve_Path(&(resolve_Path(&(resolve_Path(&(get_Paths(&(Paths), ".")), "src")), "main")), "windows")), "magma")), "Main.cpp");
	Result input = mapValue_Result(&(readString_Path(&(source))), ??? access ???);
	return /*TODO: switch*/;
}
char* compile_Main(void* _ref, char* input){
	Main* _this = (Main*) _ref;
...
List<CStructureOrUnion> createTopologicallySortedList_Main(void* _ref){
	Main* _this = (Main*) _ref;
	/*Identifier 'C' has not been defined*/ dependencyMap = collect_Iter(&(map_Iter(&(iter_List(&(_this->structuresOrUnions))), lambda39)), new_MapCollector());
	/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Identifier 'C' has not been defined]', not an object.]]', not an object.]]', not an object.]*/ cleanedDependencyMap = collect_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Identifier 'C' has not been defined]', not an object.]]', not an object.]*/(&(map_/*Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Identifier 'C' has not been defined]', not an object.]*/(&(iterEntries_/*Identifier 'C' has not been defined*/(&(dependencyMap))), lambda40)), new_MapCollector());
	/*var dependencyOrder = Lists.<String>empty()*/;
	while (isEmpty_bool(&(!cleanedDependencyMap))) {
		/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Identifier 'C' has not been defined]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/ cleanedDependencyMapKeysToRemove = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Identifier 'C' has not been defined]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(&(map_/*Not a functional type: Placeholder[input=Cannot access member 'filter' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Identifier 'C' has not been defined]', not an object.]]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(&(filter_/*Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Identifier 'C' has not been defined]', not an object.]]', not an object.]]', not an object.]]', not an object.]*/(&(iterEntries_/*Not a functional type: Placeholder[input=Cannot access member 'collect' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iterEntries' in 'Placeholder[input=Identifier 'C' has not been defined]', not an object.]]', not an object.]]', not an object.]*/(&(cleanedDependencyMap))), lambda41)), ??? access ???)));
	...
	/*Identifier 'C' has not been defined*/ mapping = collect_Iter(&(map_Iter(&(iter_List(&(_this->structuresOrUnions))), lambda42)), new_MapCollector());
...
todoLambda lambda51(void* _ref, Environment env){
	...
	List members = toList_Iter(&(flatMap_Iter(&(map_Iter(&(iter_List(&(object.children))), lambda50)), ??? access ???)));
...
Option<CStructMember> transformObject_Main(void* _ref, JObject object){
	...
	/*var fields = object.recordFields
				...
				.toList()*/;
	if (equals_/*Not a functional type: magma.Main$JRecursiveType@79698539*/(&(type_JObject(&(object))), "interface")) 
		if (contains_/*Not a functional type: JObjectType[name=List, variants=[], members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iter'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Boolean], name='isEmpty'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=Boolean], name='contains'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addAllLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Int], name='size'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@79698539], name='getFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[Int, Int], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='subList'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='clear'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@79698539, magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='mapLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iterReversed'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='copy'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeElement'}], typeParameters=[]]*/(&(modifiersList_JObject(&(object))), "sealed")) 
	...
	if (equals_String(&(object.type), "record")) {
		...
		/*Identifier 'C' has not been defined*/ joinedAssignments = collect_Iter(&(map_Iter(&(map_Iter(&(iter_List(&(recordFields))), lambda52)), ??? access ???)), new_Joiner());
...
List<CDefinable> handleSealedInterface_Main(void* _ref, JObject object, List<CDefinable> fields){
	...
	/*Not a functional type: JObjectType[name=List, variants=[], members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iter'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Boolean], name='isEmpty'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=Boolean], name='contains'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addAllLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Int], name='size'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@79698539], name='getFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[Int, Int], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='subList'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='clear'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@79698539, magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='mapLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iterReversed'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='copy'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeElement'}], typeParameters=[]]*/ typeParameters = typeParameters_JObject(&(object));
	/*Not a functional type: JObjectType[name=List, variants=[], members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iter'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Boolean], name='isEmpty'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=Boolean], name='contains'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addAllLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Int], name='size'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@79698539], name='getFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[Int, Int], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='subList'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='clear'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@79698539, magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='mapLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iterReversed'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='copy'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeElement'}], typeParameters=[]]*/ variants = variants_JObject(&(object));
	CEnum jEnum = new_CEnum(name + "Tag", variants);
	/*final var typeArguments = typeParameters.iter().<CType>map(Identifier::new).toList()*/;
	/*Not a functional type: Placeholder[input=Cannot access member 'toList' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JObjectType[name=List, variants=[], members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iter'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Boolean], name='isEmpty'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=Boolean], name='contains'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addAllLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Int], name='size'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@79698539], name='getFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[Int, Int], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='subList'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='clear'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@79698539, magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='mapLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iterReversed'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='copy'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeElement'}], typeParameters=[]]]', not an object.]]', not an object.]]', not an object.]*/ unionMembers = toList_/*Not a functional type: Placeholder[input=Cannot access member 'map' in 'Placeholder[input=Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JObjectType[name=List, variants=[], members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iter'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Boolean], name='isEmpty'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=Boolean], name='contains'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addAllLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Int], name='size'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@79698539], name='getFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[Int, Int], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='subList'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='clear'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@79698539, magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='mapLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iterReversed'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='copy'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeElement'}], typeParameters=[]]]', not an object.]]', not an object.]*/(&(map_/*Not a functional type: Placeholder[input=Cannot access member 'iter' in 'Placeholder[input=Not a functional type: JObjectType[name=List, variants=[], members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iter'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Boolean], name='isEmpty'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=Boolean], name='contains'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addAllLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Int], name='size'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@79698539], name='getFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[Int, Int], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='subList'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='clear'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@79698539, magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='mapLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iterReversed'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='copy'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeElement'}], typeParameters=[]]]', not an object.]*/(&(iter_/*Not a functional type: JObjectType[name=List, variants=[], members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iter'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Boolean], name='isEmpty'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=Boolean], name='contains'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='addAllLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Int], name='size'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@79698539], name='getFirst'}, JDeclaration {type=JFunctionalType[parameterTypes=[Int, Int], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='subList'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='clear'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@79698539, magma.Main$JRecursiveType@79698539]]], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='mapLast'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='iterReversed'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='copy'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@79698539], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@79698539]]], name='removeElement'}], typeParameters=[]]*/(&(variants))), lambda53)));
...
todoLambda lambda56(void* _ref, Environment env){
	...
	return within_Environment(&(self), lambda55);
}
CStructMember completeMethodProto_Main(void* _ref, JMethod jFunctionProto, JObject object){
	Main* _this = (Main*) _ref;
	...
	if (startsWith_String(&(jFunctionProto.content), "{") && endsWith_String(&(jFunctionProto.content), "}")) {
		char* inputContent = substring_String(&(jFunctionProto.content), 1, length_/*Not a functional type: magma.Main$JRecursiveType@79698539*/(&(content_JMethod(&(jFunctionProto)))) - 1);
...
char* lambda61(void* _ref, CDeclaration parameter){
...
CDefinable transformMethodDeclaration_Main(void* _ref, char* structName, List<char*> typeParameters, JMethodDeclaration methodDeclaration){
	Main* _this = (Main*) _ref;
	return mapName_CDefinable(&(mapTypeParameters_CDefinable(&(convertToFunctionDeclarations_Main(&((*_this)), typeParameters, methodDeclaration)), lambda64)), lambda65);
}
CDefinable convertToFunctionDeclarations_Main(void* _ref, List<char*> typeParameters, JMethodDeclaration methodDeclaration){
	Main* _this = (Main*) _ref;
	return /*TODO: switch*/;
...
State lambda69(void* _ref, State state, char character){
...
JType cleanupType_Main(void* _ref, JType type){
	...
	if (??? instanceof ???) {
		...
		if (??? instanceof ???) 
			...
			return new_Placeholder("Identifier '" + value + "' has not been defined");
	}
	if (??? instanceof ???) {
...
JType resolveMember_Main(void* _ref, JObjectType type, JType instanceType, char* name){
	Main* _this = (Main*) _ref;
	return orElseGet_Option(&(resolve_JObjectType(&(type), name)), lambda74);
}
JType resolveCaller_Main(void* _ref, JCaller caller){
	Main* _this = (Main*) _ref;
	return /*TODO: switch*/;

...
/*var joinedTypeParameters = Main.joinTypeParameters*/ (){? } /*final var identifier = implementee.toBaseName*/ (){? } /*final var s = Main.generateStatement*/ (){? } /*final var s1 = Main.generateStatement*/ (){? } /*final var s2 = Main.generateStatement*/ (){? } /*final var s3 = Main.generateStatement*/ (){? } /*final var parameters = Lists.of*/ ()
{
	?
}
new CFunctionHeader_JObject(void *_ref, /*CDeclaration(implementee,*/ conversionFunctionName)
...
/*case JField jField -> new Some<JDeclaration>*/ (){? } /*case JMethod jMethod -> jMethod.toDeclaration*/ (){? } /*case EmptyStructMember _, JObject _, Placeholder _ -> new None<JDeclaration>*/ ()
{
	?
}
char *generate_CFunctionHeader(void *_ref)
...
Option<IOError> run_Main(void *_ref)
{
	...
	/*Not a functional type: Placeholder[input=Cannot access member 'get' in 'Placeholder[input=Undefined identifier: Paths]', not an object.]*/ target = get_Paths(0, ".", "src", "main", "windows", "magma", "Main.cpp");
...
CStructMember completeMethodProto_Main(void *_ref, JMethod jFunctionProto, JObject object)
{
	...
	if (endsWith_ /*Cannot access member 'content' in 'Placeholder[input=Unwrapped expression: startsWith_startCannot access member 'content' in 'Identifier[value=JMethod]', not an object.end(jFunctionProto.content, "{") && jFunctionProto]', not an object.*/ (startsWith_ /*Cannot access member 'content' in 'Identifier[value=JMethod]', not an object.*/ (jFunctionProto.content, "{") && jFunctionProto.content, "}"))
	{
		...
		/*Not a functional type: Placeholder[input=Cannot access member 'within' in 'Placeholder[input=Member 'environment' not defined in 'JObjectType[name=Main, members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Identifier[value=new]], name='Environment'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], name='functionDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], name='globals'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], name='structureForwardDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]], name='structures'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]], name='functions'}, JDeclaration {maybeBeforeType=private, type=Identifier[value=int], name='counter'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='generateTemplateString'}, JDeclaration {type=JFunctionalType[parameterTypes=[JArrayType[type=magma.Main$JRecursiveType@577b2db2]], returnType=Void], name='main'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int], magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int]], returnType=magma.Main$JRecursiveType@577b2db2], name='generateIndent'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=CType]], name='transformType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JPrimitiveType]], returnType=Identifier[value=CType]], name='transformPrimitiveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='joinTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectType]]]], name='extractType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=CExpression]], name='transformCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=CExpression]], name='transformExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JInvokable]], returnType=Identifier[value=CInvocation]], name='transformInvocation'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=IOError]]]], name='run'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='compile'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='joinStrings'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='compileStatements'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2]], Identifier[value=Folder]], returnType=magma.Main$JRecursiveType@577b2db2], name='compileAll'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, Identifier[value=Folder]], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='divide'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=State], Char], returnType=Identifier[value=State]], name='foldStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='compileRootSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObject]]]], name='parseObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='extractField'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject], Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObjectMemberPrototype'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JMethod], Identifier[value=JObject]], returnType=Identifier[value=CStructMember]], name='completeMethodProto'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseObjectMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[Identifier[value=CStructMember]]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]], name='retainFields'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]], name='flattenSealedStructure'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=CStructMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CDefinable]]]], name='retainDefinables'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='splitValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Boolean], name='isIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], Identifier[value=JMethodDeclaration], JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]], JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]], magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='computeMethodBody'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], Identifier[value=CType], magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='createBodyForAbstractMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='transformMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='convertToFunctionDeclarations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=Identifier[value=CType]], name='toConstructorReturnType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, Identifier[value=int]], returnType=magma.Main$JRecursiveType@577b2db2], name='compileMethodsSegments'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='generateCase'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JMethodDeclaration]], name='parseMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JDeclaration]], returnType=Identifier[value=JMethodDeclaration]], name='toInterface'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JMethodDeclaration]]]], name='parseConstructor'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValuesStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='compileEnumValue'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, Identifier[value=int]], returnType=magma.Main$JRecursiveType@577b2db2], name='compileMethodSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, Identifier[value=int], magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='compileConditional'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='compileMethodStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='compileAssignment'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JAssignable], Identifier[value=JExpression]], returnType=Identifier[value=CAssignable]], name='transformAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression], Identifier[value=JType]], returnType=Identifier[value=JType]], name='resolveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveUncleanedExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JType]], name='resolveIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=JType]], name='cleanupType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectType], Identifier[value=JType], magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JType]], name='resolveMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=JType]], name='resolveCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JAssignable]], name='parseAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='post'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='compileExpressionOrPlaceholder'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CExpression]]]], name='parseCExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='compileLambda'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]]]], name='parseLambdaParams'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@577b2db2], name='generateName'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='compileOperator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseInvokable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=int]], name='findCallerStart'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Boolean], name='isNumber'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Boolean], name='allDigits'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JCaller]]]], name='parseCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='parseDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='collectAnnotations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=int]], name='findTypeSeparator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JType]], name='parseType'}]]']', not an object.]*/ within = within_ /*Member 'environment' not defined in 'JObjectType[name=Main, members=[JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=Identifier[value=new]], name='Environment'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], name='functionDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], name='globals'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], name='structureForwardDeclarations'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]], name='structures'}, JDeclaration {maybeBeforeType=private, type=JGenericType[base=List, typeArguments=[Identifier[value=CFunction]]], name='functions'}, JDeclaration {maybeBeforeType=private, type=Identifier[value=int], name='counter'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='generateTemplateString'}, JDeclaration {type=JFunctionalType[parameterTypes=[JArrayType[type=magma.Main$JRecursiveType@577b2db2]], returnType=Void], name='main'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int], magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=int]], returnType=magma.Main$JRecursiveType@577b2db2], name='generateIndent'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=CType]], name='transformType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JPrimitiveType]], returnType=Identifier[value=CType]], name='transformPrimitiveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='generateStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='joinTypeParameters'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectType]]]], name='extractType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=CExpression]], name='transformCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=CExpression]], name='transformExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JInvokable]], returnType=Identifier[value=CInvocation]], name='transformInvocation'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=IOError]]]], name='run'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='compile'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='joinStrings'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='compileStatements'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=F1R, typeArguments=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2]], Identifier[value=Folder]], returnType=magma.Main$JRecursiveType@577b2db2], name='compileAll'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, Identifier[value=Folder]], returnType=JGenericType[base=Iter, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='divide'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=State], Char], returnType=Identifier[value=State]], name='foldStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='compileRootSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObject]]]], name='parseObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObject'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='extractField'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObject], Identifier[value=JObjectMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='transformObjectMemberPrototype'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JMethod], Identifier[value=JObject]], returnType=Identifier[value=CStructMember]], name='completeMethodProto'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseObjectMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[Identifier[value=CStructMember]]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CDefinable]]]], name='retainFields'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=JGenericType[base=List, typeArguments=[Identifier[value=CRootSegment]]]], name='flattenSealedStructure'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=CStructMember]], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CDefinable]]]], name='retainDefinables'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='splitValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Boolean], name='isIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], Identifier[value=JMethodDeclaration], JGenericType[base=List, typeArguments=[Identifier[value=CDeclaration]]], JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]], magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='computeMethodBody'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], Identifier[value=CType], magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=magma.Main$JRecursiveType@577b2db2], name='createBodyForAbstractMethod'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='transformMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]], Identifier[value=JMethodDeclaration]], returnType=Identifier[value=CFunctionDeclaration]], name='convertToFunctionDeclarations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], returnType=Identifier[value=CType]], name='toConstructorReturnType'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, Identifier[value=int]], returnType=magma.Main$JRecursiveType@577b2db2], name='compileMethodsSegments'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='generateCase'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JMethodDeclaration]], name='parseMethodDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JDeclaration]], returnType=Identifier[value=JMethodDeclaration]], name='toInterface'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JMethodDeclaration]]]], name='parseConstructor'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValuesStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JObjectMember]]]], name='parseEnumValues'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CStructMember]]]], name='compileEnumValue'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, Identifier[value=int]], returnType=magma.Main$JRecursiveType@577b2db2], name='compileMethodSegment'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, Identifier[value=int], magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='compileConditional'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='compileMethodStatement'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='compileAssignment'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JAssignable], Identifier[value=JExpression]], returnType=Identifier[value=CAssignable]], name='transformAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression], Identifier[value=JType]], returnType=Identifier[value=JType]], name='resolveType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JExpression]], returnType=Identifier[value=JType]], name='resolveUncleanedExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JType]], name='resolveIdentifier'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JType]], returnType=Identifier[value=JType]], name='cleanupType'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JObjectType], Identifier[value=JType], magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JType]], name='resolveMember'}, JDeclaration {type=JFunctionalType[parameterTypes=[Identifier[value=JCaller]], returnType=Identifier[value=JType]], name='resolveCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JAssignable]], name='parseAssignable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='post'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=magma.Main$JRecursiveType@577b2db2], name='compileExpressionOrPlaceholder'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=CExpression]]]], name='parseCExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseExpression'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='compileLambda'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]]]], name='parseLambdaParams'}, JDeclaration {type=JFunctionalType[parameterTypes=[], returnType=magma.Main$JRecursiveType@577b2db2], name='generateName'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2, magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='compileOperator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JExpression]]]], name='parseInvokable'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=int]], name='findCallerStart'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Boolean], name='isNumber'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Boolean], name='allDigits'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JCaller]]]], name='parseCaller'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=Option, typeArguments=[Identifier[value=JDeclaration]]]], name='parseDeclaration'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=JGenericType[base=List, typeArguments=[magma.Main$JRecursiveType@577b2db2]]], name='collectAnnotations'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=int]], name='findTypeSeparator'}, JDeclaration {type=JFunctionalType[parameterTypes=[magma.Main$JRecursiveType@577b2db2], returnType=Identifier[value=JType]], name='parseType'}]]'*/ (_this->environment, lambda25);
		_this->environment = within.left;
...
{
	Main *_this = (Main *)_ref;
	/*Not a functional type: Placeholder[input=Member 'split' not defined in 'magma.Main$JRecursiveType@577b2db2']*/ segments = split_char_ptr(input, quote_ /*Undefined identifier: Pattern*/ (Pattern, ","));
...
Option<List<char *>> parseLambdaParams_Main(void *_ref, char *input)
{
	...
	else if (startsWith_char_ptr(input, "(") && input.endsWith(")"))
	{

...
public CompileError_CompileError(String reason, Context context, List<CompileError> causes) implements Error(String reason, Context sourceCode) {}
String display_CompileError(String reason, Context context, List<CompileError> causes) implements Error() {}
String format_CompileError(String reason, Context context, List<CompileError> causes) implements Error(int depth, int index) {}

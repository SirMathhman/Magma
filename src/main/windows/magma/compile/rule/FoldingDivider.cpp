...
Stream<String> divide_FoldingDivider(char* input) {/*DivideState current = new DivideState(input);*//*while (true) {
...
char* delimiter_FoldingDivider() {/*return folder.delimiter();*/}

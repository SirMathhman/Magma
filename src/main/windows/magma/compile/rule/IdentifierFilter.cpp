...
boolean test_IdentifierFilter(char* input) {/*for (int i = 0;*//*i < input.length();*//*i++) {if (!Character.isLetterOrDigit(input.charAt(i))) return false;}*//*return true;*/}
char* createErrorMessage_IdentifierFilter() {/*return "Not an identifier";*/}

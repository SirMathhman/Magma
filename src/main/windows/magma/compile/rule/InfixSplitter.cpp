...
Option<Tuple<String, String>> split_InfixSplitter(char* input) {/*return switch (locator.locate(input, infix)) {
...
char* createErrorMessage_InfixSplitter() {/*return "Infix '" + infix + "' not present";*/}
char* merge_InfixSplitter(char* left, char* right) {/*return left + infix + right;*/}

...
public class ArrayTest {
	...
	public void testCompileArrayDeclaration() {
		...
		assertTrue(cCode.contains("uint8_t myArray[3] = {1, 2, 3};"), "C code should declare and initialize the array with the correct type and size");
	...
	public void testCompileArraysOfDifferentTypes() {
		...
		assertTrue(cCode.contains("int main("), "C code should have a main function");
		assertTrue(cCode.contains("uint8_t byteArray[4] = {10, 20, 30, 40};"), "C code should declare and initialize the byte array");
		assertTrue(cCode.contains("int32_t intArray[2] = {100, 200};"), "C code should declare and initialize the int array");
		assertTrue(cCode.contains("bool boolArray[3] = {true, false, true};"), "C code should declare and initialize the bool array");
		assertTrue(cCode.contains("return 0;"), "C code should return 0");
	}
}
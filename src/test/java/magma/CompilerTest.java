...
class CompilerTest {
	...
	void ifStatementTest() {
		...
		assertValid("let a = true; let b = false; if (a || b) { let result = 100; }",
								"bool a = true;\nbool b = false;\nif (a || b) {\nint32_t result = 100;\n}");
		assertValid("let a = false; if (!a) { let result = 100; }", "bool a = false;\nif (!a) {\nint32_t result = 100;\n}");
	...
	@Test
	void ifElseStatementTest() {
		// Test if-else statement with boolean literal condition
		assertValid("if (true) { let x = 10; } else { let y = 20; }",
								"if (true) {\nint32_t x = 10;\n} else {\nint32_t y = 20;\n}");
		assertValid("if (false) { let x = 10; } else { let y = 20; }",
								"if (false) {\nint32_t x = 10;\n} else {\nint32_t y = 20;\n}");

		// Test if-else statement with boolean variable condition
		assertValid("let flag = true; if (flag) { let x = 10; } else { let y = 20; }",
								"bool flag = true;\nif (flag) {\nint32_t x = 10;\n} else {\nint32_t y = 20;\n}");

		// Test if-else statement with comparison condition
		assertValid("let a = 5; let b = 10; if (a < b) { let result = 100; } else { let result = 200; }",
								"int32_t a = 5;\nint32_t b = 10;\nif (a < b) {\nint32_t result = 100;\n} else {\nint32_t result = 200;\n}");
		assertValid("if (5 == 5) { let result = true; } else { let result = false; }",
								"if (5 == 5) {\nbool result = true;\n} else {\nbool result = false;\n}");

		// Test if-else statement with logical operation condition
		assertValid("let a = true; let b = false; if (a && b) { let result = 100; } else { let result = 200; }",
								"bool a = true;\nbool b = false;\nif (a && b) {\nint32_t result = 100;\n} else {\nint32_t result = 200;\n}");

		// Test if-else statement with multiple statements in bodies
		assertValid("if (true) { let x = 10; let y = 20; } else { let a = 30; let b = 40; }",
								"if (true) {\nint32_t x = 10;\nint32_t y = 20;\n} else {\nint32_t a = 30;\nint32_t b = 40;\n}");

		// Test if-else statement with empty bodies
		assertValid("if (true) { } else { }", "if (true) {\n\n} else {\n\n}");
		assertValid("if (true) { let x = 10; } else { }", "if (true) {\nint32_t x = 10;\n} else {\n\n}");
		assertValid("if (true) { } else { let y = 20; }", "if (true) {\n\n} else {\nint32_t y = 20;\n}");
	}
	...
	void invalidIfStatementTest() {
		...
		// Test if-else statement without parentheses
		assertInvalid("if true { let x = 10; } else { let y = 20; }");

		// Test if-else statement without braces around if body
		assertInvalid("if (true) let x = 10; else { let y = 20; }");

		// Test if-else statement without braces around else body
		assertInvalid("if (true) { let x = 10; } else let y = 20;");

		// Test if-else statement with non-boolean condition

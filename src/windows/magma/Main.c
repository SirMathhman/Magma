struct Main {
	...
	struct String assembleFunction(void* __self__, int depth, template Collection<struct Parameter> oldParams, struct Parameter definition, struct String content) {
